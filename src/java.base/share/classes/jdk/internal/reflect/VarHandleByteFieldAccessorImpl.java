...
final class VarHandleByteFieldAccessorImpl extends VarHandleFieldAccessorImpl {
    static FieldAccessorImpl fieldAccessor(Field field, MethodHandle getter, MethodHandle setter) {
        return new VarHandleByteFieldAccessorImpl(field, getter, setter);
    }

    private VarHandleByteFieldAccessorImpl(Field field, MethodHandle getter, MethodHandle setter) {
